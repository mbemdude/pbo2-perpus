...
public class AnggotaAddFrame extends javax.swing.JFrame {
    ...
    public AnggotaAddFrame(int id) {
        ...
        try {
            ...
            String findSQL = "SELECT * FROM anggota WHERE id="+id;
    ...
    private void simpanButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_simpanButtonActionPerformed
        if(idTextField.getText().equals("")) {
            try{
                Connection koneksi = Database.getConnection();
                String insertSQL = "INSERT INTO anggota (nama, jenis_kelamin, telp, alamat) VALUES ('"
            ...
            try {
                Connection koneksi = Database.getConnection();
                String updateSQL = "UPDATE anggota SET nama = '" +
