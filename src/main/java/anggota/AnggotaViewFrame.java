 ...
 * @author mbemd
 */
public class AnggotaViewFrame extends javax.swing.JFrame {

    /**
     * Creates new form AnggotaViewFrame
     */
    public AnggotaViewFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        editButton.setMaximumSize(new java.awt.Dimension(73, 23));
        editButton.setMinimumSize(new java.awt.Dimension(73, 23));
        ...
        resetButton.setMaximumSize(new java.awt.Dimension(73, 23));
        resetButton.setMinimumSize(new java.awt.Dimension(73, 23));
        ...
        hapusButton.setMaximumSize(new java.awt.Dimension(73, 23));
        hapusButton.setMinimumSize(new java.awt.Dimension(73, 23));
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(tambahButton, javax.swing.GroupLayout.PREFERRED_SIZE, 121, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
    ...
    private void cariButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cariButtonActionPerformed
        try {
            ...
            String selectSQL = "SELECT * FROM anggota WHERE nama LIKE '%"+kataKunci+"%' ";
            ...
            while(resultSet.next()) {
                ...
                row[2] = resultSet.getString("jenis_kelamin");
    ...
    private void tambahButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tambahButtonActionPerformed
        AnggotaAddFrame f = new AnggotaAddFrame();
        f.setVisible(true);
    ...
    private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonActionPerformed
        ...
        if(barisTerpilih >= 0) {
            ...
            AnggotaAddFrame f = new AnggotaAddFrame(id);
            f.setVisible(true);
        } else {
        ...
        if(barisTerpilih >= 0) {
            ...
            if(pilihan == 0) {
                try {
                    ...
                    int id = (int) model.getValueAt(barisTerpilih, 0);
                    Connection koneksi = Database.getConnection();
                    String deleteSQL = "DELETE FROM anggota WHERE id ="+id;
                    Statement statement = koneksi.createStatement();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AnggotaViewFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AnggotaViewFrame().setVisible(true);
            }
        });
    }
