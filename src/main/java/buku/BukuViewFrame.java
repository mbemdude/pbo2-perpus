...
public class BukuViewFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        viewTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Judul Buku", "Tanggal Terbit", "Jumlah Buku", "IDBN", "Pengarang", "Penerbit", "Rak"
            }
        ) {
    ...
    private void cariButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cariButtonActionPerformed
        try {
            ...
            String selectSQL = "SELECT B.id, B.judul, B.tahun_terbit, B.jumlah, B.idbn"
                    + " PN.nama, PB.nama, R.kd_rak FROM buku B LEFT JOIN pengarang PN ON B.pengarang_id=PN.id"
                    + " LEFT JOIN penerbit PB ON B.penerbit_id=PB.id LEFT JOIN rak R ON B.rak_id=R.id"
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        ...
        try{
            Connection koneksi = Database.getConnection();
            String selectSQL = "SELECT B.id, B.judul, B.tahun_terbit, B.jumlah, B.idbn, PN.nama,  "
                    + "PB.nama, R.kd_rak FROM buku B LEFT JOIN pengarang PN ON B.pengarang_id=PN.id "
                    + "LEFT JOIN penerbit PB ON B.penerbit_id=PB.id LEFT JOIN rak R ON B.rak_id=R.id;";
            Statement statement = koneksi.createStatement();
            ResultSet resultSet = statement.executeQuery(selectSQL);
            ...
            while(resultSet.next()) {
                row[0] = resultSet.getInt("B.id");
                row[1] = resultSet.getString("B.judul");
                row[2] = resultSet.getString("B.tahun_terbit");
                row[3] = resultSet.getString("B.jumlah");
                row[4] = resultSet.getString("B.idbn");
                row[5] = resultSet.getString("PN.nama");
                row[6] = resultSet.getString("PB.nama");
                row[7] = resultSet.getString("R.kd_rak");
                model.addRow(row);
            }
            koneksi.close();
        } catch (SQLException ex) {
