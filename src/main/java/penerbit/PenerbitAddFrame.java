 ...
 * @author mbemd
 */
public class PenerbitAddFrame extends javax.swing.JFrame {

    /**
     * Creates new form PenerbitAddFrame
     */
    public PenerbitAddFrame() {
        initComponents();
    }
    
    public PenerbitAddFrame(int id) {
        initComponents();
        try {
            Connection koneksi = Database.getConnection();
            String findSQL = "SELECT * FROM penerbit WHERE id="+id;
    ...
    private void simpanButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_simpanButtonActionPerformed
        if(idTextField.getText().equals("")) {
            try{
                Connection koneksi = Database.getConnection();
                String insertSQL = "INSERT INTO penerbit (nama, telp, alamat, email) VALUES ('"
            ...
            try {
                Connection koneksi = Database.getConnection();
                String updateSQL = "UPDATE penerbit SET nama = '" +
                namaTextField.getText() + "', telp = '"+
                noTelpTextField.getText() + "', alamat = '"+
                alamatTextField.getText() + "', email = '"+
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PenerbitAddFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PenerbitAddFrame().setVisible(true);
            }
        });
    }
