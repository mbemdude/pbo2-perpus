 ...
 * @author mbemd
 */
public class PetugasViewFrame extends javax.swing.JFrame {

    /**
     * Creates new form PetugasViewFrame
     */
    public PetugasViewFrame() {
        initComponents();
    }
    ...
    private void cariButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cariButtonActionPerformed
        try {
            ...
            String selectSQL = "SELECT * FROM petugas WHERE nama LIKE '%"+kataKunci+"%' ";
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        ...
        try{
            Connection koneksi = Database.getConnection();
            String selectSQL = "SELECT * FROM petugas";
            Statement statement = koneksi.createStatement();
            ResultSet resultSet = statement.executeQuery(selectSQL);
    ...
    private void tambahButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tambahButtonActionPerformed
        PetugasAddFrame f = new PetugasAddFrame();
        f.setVisible(true);
    ...
    private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonActionPerformed
        ...
        if(barisTerpilih >= 0) {
            ...
            PetugasAddFrame f = new PetugasAddFrame(id);
            f.setVisible(true);
        } else {
        ...
        if(barisTerpilih >= 0) {
            ...
            if(pilihan == 0) {
                try {
                    ...
                    int id = (int) model.getValueAt(barisTerpilih, 0);
                    Connection koneksi = Database.getConnection();
                    String deleteSQL = "DELETE FROM petugas WHERE id ="+id;
                    Statement statement = koneksi.createStatement();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PetugasViewFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PetugasViewFrame().setVisible(true);
            }
        });
    }
